...
public class ImportWindow : EditorWindow
{
    ...
    {
        string[] filters = { "ERA Files", "era" };

        string file = EditorUtility.OpenFilePanelWithFilters("Select ERA File", "", filters);
    ...
    {
        string projectPath = Path.Combine(Directory.GetParent(Application.dataPath).FullName, "Assets", "Projects", projectName);

...
namespace Forge.Decompiler
{
    public static class FileProcessor
    {
        ...
        public static async Task ProcessEraFile(string file, string outputPath)
        {
            ...
            await PhxToolHandler.RunPhxToolAsync(BuildArguments("decrypt", fileNameWithoutExt, Path.GetDirectoryName(file), tempDir));
            ...
            await PhxToolHandler.RunPhxToolAsync(BuildExpandArguments(fileNameWithoutExt, tempDir, outputPath));
        }
